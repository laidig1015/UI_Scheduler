...
namespace UI_Scheduler_Tool.Tests.Models
{
    ...
    public class SchdeulerTest
    {
        ...
        public void NodeOverlap()
        {
            ...
            // b (Jan 1st 2015 @ 9:00AM - 12:00PM)
            a = new Scheduler.Node(new DateTime(2015, 1, 1, 8, 0, 0).UnixTimestamp(),
                                   new DateTime(2015, 1, 1, 10, 0, 0).UnixTimestamp());
            b = new Scheduler.Node(new DateTime(2015, 1, 1, 9, 0, 0).UnixTimestamp(),
            ...
            a = new Scheduler.Node(new DateTime(2015, 1, 1, 8, 0, 0).UnixTimestamp(),
                                   new DateTime(2015, 1, 1, 10, 0, 0).UnixTimestamp());
            b = new Scheduler.Node(new DateTime(2015, 1, 1, 8, 0, 0).UnixTimestamp(),
                                   new DateTime(2015, 1, 1, 10, 0, 0).UnixTimestamp());
            Assert.IsTrue(a.Overlaps(b), "The nodes A({0}) and B({1}) should overlap", a, b);
            ...
            a = new Scheduler.Node(new DateTime(2015, 1, 1, 8, 0, 0).UnixTimestamp(),
                                   new DateTime(2015, 1, 1, 10, 0, 0).UnixTimestamp());
            b = new Scheduler.Node(new DateTime(2015, 1, 1, 11, 0, 0).UnixTimestamp(),
